        ...
        $row = mysql_fetch_array($query);
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" method="POST" action="edit_news.php" enctype="multipart/form-data">
								<div class="form-group">
									<label>ID Berita</label>
                                    <input class="form-control" placeholder="ID Berita" name="id_berita" value="<?php echo $id; ?>" readonly></div>
                                <div class="form-group">
									<label>Judul Berita</label>
									<input class="form-control" placeholder="Judul Berita" name="judul" value="<?php echo $row['JUDUL_BERITA']; ?>" required>
								</div>
								<div class="form-group">
									<label>Keterangan Berita</label>
									<input class="form-control" type="text"  maxlength="250" placeholder="Keterangan Berita" name="keterangan" value="<?php echo $row['KETERANGAN_BERITA']; ?>" required>
								</div>
								<div class="form-group">
                    ...
                    if($row['GAMBAR_BERITA']){
                        echo $row['GAMBAR_BERITA'];
                    } 
                    else echo "images/thumbnail.png";?>">
