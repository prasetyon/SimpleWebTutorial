...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">			
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Masukkan Berita</h1>
			</div>
		</div>
			...
			<div class="col-lg-12">
				<div class="panel panel-default">
					<div class="panel-body">
						<div class="col-md-6">
							<form role="form" method="POST" action="add_news.php" enctype="multipart/form-data">
								<div class="form-group">
									<label>ID Berita</label>
                                    <input class="form-control" placeholder="ID Berita" name="id_berita" required></div>
                                <div class="form-group">
									<label>Judul Berita</label>
									<input class="form-control" placeholder="Judul Berita" name="judul" required>
								</div>
								<div class="form-group">
									<label>Keterangan Berita</label>
									<input class="form-control" type="text"  maxlength="250" placeholder="Keterangan Berita" name="keterangan" required>
								</div>
								<div class="form-group">
